...
const Stores = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "rawMaterial":
        return <div> <RawMaterialStore /> </div>;
      case "packingMaterial":
        return <div> <PackingMaterialStore /> </div>;
      case "chemicalMaterial":
        return <div> <ChemicalMaterialStore /> </div>;
      case "etoStoreForSterlization":
        return <div> <ETOSterlizationStore /> </div>;
      case "etoQuarantineStore":
        return <div> <ETOQuarantineStore /> </div>;
        case "finishGoodsStore":
        return <div> <FinishGoodsStore /> </div>;
      default:
