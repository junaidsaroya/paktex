...
export const addIntimate = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({
        message: 'Product intimate added successfully.',
        data: savedIntimate,
      });
  } catch (error) {
    res
      .status(500)
      .json({message: 'Failed to add product intimate.', error: error.message});
  }
};
...
export const getAllIntimates = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({message: 'Records fetched successfully.', data: intimates});
  } catch (error) {
    res
      .status(500)
...
export const getIntimateProduct = async (req, res) => {
  try {
    const {name, batchName} = req.query;
...
export const getIntimateById = async (req, res) => {
  try {
    const intimate = await ProductIntimate.findById(req.params.id).populate(
      'productId',
      'productName'
    );
    ...
    res
      .status(200)
      .json({message: 'Record fetched successfully.', data: intimate});
  } catch (error) {
    res
      .status(500)
...
export const updateStatus = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({message: 'Status updated successfully', updatedProduct});
  } catch (error) {
