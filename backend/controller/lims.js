...
export const addLims = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({message: 'Lims entry added successfully', data: savedLims});
  } catch (error) {
...
export const getAllLims = async (req, res) => {
  try {
    const limsEntries = await Lims.find();
    res
      .status(200)
      .json({message: 'Lims entries fetched successfully', data: limsEntries});
  } catch (error) {
...
export const getLimsById = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({message: 'Lims entry fetched successfully', data: limsEntry});
  } catch (error) {
...
export const deleteLimsById = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({message: 'Lims entry deleted successfully', data: deletedLims});
  } catch (error) {
